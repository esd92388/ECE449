...
static std::string dataFile = "ranges.txt";
	...
	void playSound(std::string s){
		if(s == "Harder"){
			system("sudo mpg321 --stereo -q /home/pi/DPSamples/harder.mp3");
		}
		if(s == "Better"){
			system("sudo mpg321 --stereo -q /home/pi/DPSamples/better.mp3");
		}
		if(s == "Faster"){
			system("sudo mpg321 --stereo -q /home/pi/DPSamples/faster.mp3");
		}
		if(s == "Stronger"){
			system("sudo mpg321 --stereo -q /home/pi/DPSamples/stronger.mp3");
		}
	}
 
//Interrupts for GeoPhones
        PI_THREAD (IT) {
